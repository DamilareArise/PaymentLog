        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
            <div style={{
              ...
              background: `rgba(88,56,32,0.1)`, display: 'flex', alignItems: 'center', justifyContent: 'center'
            }}>
              <span style={{ fontSize: '18px' }}>👔</span>
            </div>
            <h2 style={{ color: C.text, fontSize: '20px', fontWeight: '700', margin: 0 }}>
              Staff Sign In
            </h2>
          </div>
          ...
          <form onSubmit={formik.handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            <div>
              ...
              <input
                ...
                placeholder="staff@orofoluwa.edu.ng"
            ...
            >
              {formik.isSubmitting ? 'Signing in...' : 'Sign In to Staff Portal'}
            </button>
          </form>

          {/* Role indicator */}
          <div style={{
            marginTop: '20px', padding: '12px 16px', background: C.light, borderRadius: '8px',
            border: '1px solid rgba(88,56,32,0.1)', fontSize: '13px', color: '#8B5E3C'
          }}>
            <strong style={{ color: C.primary }}>Access Levels:</strong> Admins have full system access.
            Teachers can manage their subjects, students, and CBT exams.
          </div>

          <div style={{ textAlign: 'center', marginTop: '20px' }}>
            <p style={{ color: '#8B5E3C', fontSize: '13px' }}>
              Are you a student?{' '}
              <Link to="/student-login" style={{ color: C.primary, fontWeight: '600', textDecoration: 'none' }}>
                Student Portal →
              </Link>
            </p>
          </div>
