  ...
  return (
    <div className="h-screen bg-[#FAF8F8] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <thead>
            <tr className="/bg-gray-200">
              ...
              <th className="px-[4px] w-[30%] md:px-3 border-t py-5 border-b text-[10px] md:text-[16px] font-[500]">
                Pay ID
              </th>
            </tr>
          </thead>
          ...
          <tfoot>
            <tr className=" ">
              ...
              <td
                colSpan="2"
                className="p-3 border-t font-bold border-l-[1px] align-middle"
              >
      ...
      <footer className="flex /justify-between items-center h-[50px] md:h-[100px] /p-5 mt- text-[12px][md:] bg-[#583820] text-white rounded-tl-[100px]">
        <p className="ml-[50px] md:ml-[100px] font-[500] text-[14px] md:text-[18px]">
          @ Copyright 2024
        </p>
      </footer>
    </div>
